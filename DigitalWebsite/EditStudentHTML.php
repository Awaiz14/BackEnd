    ...
    <body>
      ...
      <table> <!-- Creates table on webpage -->
        ...
        if ($conn->connect_error) {
          ...
          studentEmail, studentAddress, className, teacherID, parent1ID, parent2ID,
          medicalInfo FROM students";
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<td> <button><a href='EditStudentUpdate.php?id=".$row['studentID']."'>Update</a></button>
              <button><a href='EditStudentDelete.php?id=".$row['studentID']."'>Delete</a></button></td>";
              echo "</tr>";
          }
